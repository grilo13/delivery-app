...
FINISH_TOPIC = os.getenv('FINISH_TOPIC', 'finish')
    ...
    try:
        ...
        async for msg in consumer:
            ...
            try:
                ...
                update_values = {"$set": {'status': "finished", 'update_date': current_datetime}}
            ...
            try:
                # Produce message
                await producer.send_and_wait(FINISH_TOPIC, str(order).encode('utf-8'))
            finally:
